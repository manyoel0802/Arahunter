...
def calculate_bandar_confidence(df, v_ratio):
    ...
    except: return 50, "ANALYSIS N/A", "bg-neu"
...
def analyze_sentiment_pro(ticker_obj):
    ...
    except: return "NEUTRAL", 50

# --- UI APP ---
if 'history' not in st.session_state: st.session_state['history'] = []

st.title("🦅 GOD MODE V15.4")
st.caption("Fix Multiple ID Error | Institutional Flow | Anti-Crash")
        ...
        try:
            ...
            if not df_raw.empty:
                ...
                if not df_scan.empty:
                    pesan_tele = f"🦅 <b>V15.4 MASTER REPORT</b>\n"
                    for idx, row in df_scan.iterrows():
                        ...
                        if not df_hist.empty:
                            ...
                            with t2:
                                ...
                                st.plotly_chart(fig, use_container_width=True, key=f"gauge_{row['name']}")
            ...
            else: st.info("Pasar sedang sepi.")
